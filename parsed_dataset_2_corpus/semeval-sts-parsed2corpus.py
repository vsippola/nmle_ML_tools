...
python3.10 semeval-sts-parsed2corpus.py -input_folder ../../parsed_data/stsbenchmark/ -output_folder ../../corpus_data/stsbenchmark_w2sense/ -word2vec_folder ../../word2vec_pickles/word2sense/
...
class sts_parsed2corpus_const:
	...
	CORUPUS_OUTPUT = {'sts-dev.csv':'dev.pkl', 'sts-test.csv':'test.pkl', 'sts-train.csv':'train.pkl'}
	CORPUS_FILES = ['sts-dev.csv', 'sts-test.csv', 'sts-train.csv']
