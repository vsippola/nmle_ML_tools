...
python3.10 glove_counterfit_pickle.py -input_file "../../../raw_data/glove_counter-fitted-vectors.txt" -output_folder "../../word2vec_pickles/glove_counter/"
...
def process_textfile(input_path, output_folder):
	...
	vocab, vecs = parse_textfile(input_path)
...
def main():
	...
	process_textfile(args.input_file, args.output_folder)
